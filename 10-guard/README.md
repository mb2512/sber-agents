...
- 🛠️ **5 типов инструментов:**
  ...
  - `open_credit_card` - открытие карт с Human-in-the-Loop подтверждением (MCP)
...
- 💳 **Открытие карт** - требует явного одобрения пользователя
...
- Python 3.11-3.13 (Python 3.14 не поддерживается зависимостями)
