...
Были протестированы модели эмбеддингов от **Fireworks**:

1. **qwen3-embedding-8b** — основная используемая модель
   - Хорошее качество векторных представлений
   - Стабильная работа с русскоязычными документами
   - Поддержка контекста до 8K токенов

2. Альтернативные варианты (OpenRouter):
   - **text-embedding-3-large** — модель OpenAI через OpenRouter
   - Высокое качество, но требует API ключ OpenRouter
...
![Качество эмбеддингов - Скриншот 1](screenshots/photo3(качество_эмбеддингов).JPG)

![Качество эмбеддингов - Скриншот 2](screenshots/photo4(качество_эмбеддингов).JPG)
